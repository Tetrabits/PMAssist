...
namespace PMAssist.Controllers
{
    ...
    public class LeaveInformationController : Controller
    {
        ...
        // GET: LeaveInformationController/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: LeaveInformationController/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: LeaveInformationController/Create
        [HttpPost]
        ...
        // GET: LeaveInformationController/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: LeaveInformationController/Edit/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: LeaveInformationController/Delete/5
        public ActionResult Delete(int id)
        {
            return View();
        }

        // POST: LeaveInformationController/Delete/5
        [HttpPost]
        [ValidateAntiForgeryToken]
